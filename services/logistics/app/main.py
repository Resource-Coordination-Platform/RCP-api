...
from app.api import routes_inventory, routes_requests, routes_volunteers,routes_payments,routes_alerts,routes_safezones
...
app.include_router(routes_safezones.router)  
