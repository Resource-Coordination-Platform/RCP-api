"""Outbox relay for the logistics service (same guarantees as IAM's:
publisher confirms, FOR UPDATE SKIP LOCKED, persistent messages)."""
...
log = logging.getLogger("logistics.outbox-relay")
